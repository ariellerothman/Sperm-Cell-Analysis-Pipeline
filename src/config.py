...
Smooths inter-slice boundaries from 2D-to-3D reconstruction, reducing vertex count.
Range: 0.0-3.0. Typical: 1.0-1.5 (good balance of smoothing vs detail).
Higher = fewer verts but less detail."""

MESH_DECIMATE_RATIO = 0.7
"""Mesh decimation ratio (0.0-1.0).

After marching cubes, reduces triangle count to this fraction of original.
Example: 0.7 keeps 70% of triangles, removing 30%.
Range: 0.3 (aggressive) to 1.0 (no decimation).
Typical: 0.5-0.75 for 50-75% reduction in vertex count."""
