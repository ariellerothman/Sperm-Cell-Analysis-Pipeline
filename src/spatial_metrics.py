...
def compute_spatial_metrics(
    ...
    **Coordinate System Note:**
    ...
    # Convert to physical coordinates before computing angle
    vector_to_ref_phys = vector_to_ref * np.array(VOXEL_SIZE)
    angle_deg = angle_between_vectors(vector_to_ref_phys, direction_vector)
