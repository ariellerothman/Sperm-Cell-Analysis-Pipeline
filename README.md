...
- **Comprehensive metrics** including volume, surface area, sphericity, and spatial relationships
...
2. Run Step 2a: Tracking conversions (using Mtrack2 CSVs)
...
**Use when**: Analyzing multiple sperm cells for statistical comparison.
...
**Development**: This project was developed with assistance from GitHub Copilot (Claude Haiku 4.5), which helped generate and refine code implementations.
